## форк проекта для тестирования CI/CD платформ в рамках выполнения Выпускной Квалификационной Работы Магистра

Внесены изменения в docker-file - expose->port и сами порты
...
```
git clone https://github.com/DaniyarIrkagaliev/Docker-Compose-Prometheus-and-Grafana.git
